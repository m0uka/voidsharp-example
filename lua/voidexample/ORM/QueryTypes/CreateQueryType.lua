  ...
  namespace.class("CreateQueryType", function (namespace)
    ...
    GenerateQuery = function (this, type)
      ...
      for _, property in System.each(properties) do
        ...
        local columnLength = Attributes.ColumnLengthAttribute.GetAttributeColumnLength(property)
        ...
        local isPrimaryKey = Attributes.PrimaryKeyAttribute.IsPrimaryKey(property)
