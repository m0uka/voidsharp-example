  ...
  namespace.class("CreateQueryType", function (namespace)
    ...
    GenerateQuery = function (this, type)
      ...
      for _, property in System.each(properties) do
        ...
        local columnLength = VoidAccessoriesAttributes.ColumnLengthAttribute.GetAttributeColumnLength(property)
        ...
        local isPrimaryKey = VoidAccessoriesAttributes.PrimaryKeyAttribute.IsPrimaryKey(property)
