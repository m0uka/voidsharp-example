...
System.import(function (out)
  ...
  ListAlterSpecifier = System.List(VoidAccessoriesSpecifiers.AlterSpecifier)
end)
  ...
  namespace.class("AlterQueryType_1", function (namespace)
    return function (T)
      ...
      AddColumn = function (this, name, dataType)
        local specifier = VoidAccessoriesSpecifiers.AlterSpecifier(name, dataType)
      ...
      class = {
        ...
        __metadata__ = function (out)
          return {
            properties = {
              { "AddColumns", 0x1, System.List(out.VoidAccessories.ORM.Specifiers.AlterSpecifier) }
            },
            methods = {
